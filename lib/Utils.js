...
Stravi.Utils.prototype.tileCounter = 0;
Stravi.Utils.prototype.tiles = [];
...
Stravi.Utils.prototype.imageLoaded = function() {
...
Stravi.Utils.prototype.preloadTiles = function() {
    ...
    for (type in Stravi._settings.terrain)
    {
        ...
        var preloadTile = new Kinetic.RegularPolygon({
            ...
            x: 100,
            y: 100,
            radius: Stravi._settings.tileRadius+1,
...
Stravi.Utils.prototype.tileLoaded = function(type, img)
{
    this.tiles[type] = img;
    ...
    for (type in Stravi._settings.terrain)
    {
        ...
        if (terrain.percentage > 0)
        {
            ...
            while (terrainTiles > 0)
            {
                ...
                tileCollection.update({'_id': tile[0]._id}, {$set: {'type': type}}, function() { console.log('terrain update'); });
                generated++;
